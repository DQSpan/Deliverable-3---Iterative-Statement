...
try
{
    ...
    if (n > 1 && n < 100)
    {
        ...
        if (series == "odd")
        {
            Console.WriteLine("You have selected the odd series. The numbers between 0 and " + n + " are: ");
            for (int i = 1; i < n; i = i + 2)
                Console.WriteLine(i);
        }
        else if (series == "even")
        {
            Console.WriteLine("You have selected the even series. The numbers between 0 and " + n + " are: ");
